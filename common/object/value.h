...
#define IS_NIL(v) (v == NULL || vtype(v) == NIL)
#define IS_BOOL(v) (!IS_NIL(v) && vtype(v) == BOOL)
#define IS_NUM(v) (!IS_NIL(v) && vtype(v) == NUMBER)
#define IS_STRING(v) (!IS_NIL(v) && vtype(v) == OBJ_STRING)
#define IS_NATIVE(v) (!IS_NIL(v) && vtype(v) == OBJ_NATIVE)
#define IS_FUNCTION(v) (!IS_NIL(v) && vtype(v) == OBJ_FUNCTION)
#define IS_CLOSURE(v) (!IS_NIL(v) && vtype(v) == OBJ_CLOSURE)
